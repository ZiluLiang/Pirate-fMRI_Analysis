...
## load data
```{r}
res_path = 'D:\\OneDrive - Nexus365\\Project\\pirate_fmri\\Analysis\\data\\fmri\\ROIRSA\\LSA_stimuli_navigationseparatecentering\\roirsa.csv'
...
for (a_name in names(analysis)){
  ...
  ggsave(
  file.path('D:\\OneDrive - Nexus365\\Project\\pirate_fmri\\Analysis\\data\\fmri\\ROIRSA\\LSA_stimuli_navigationseparatecentering',str_c(a_name,'.png')),
  plot = p,
  device = "png",
  scale = 1,
  width = 16,
