...
exptid  = 'PKHDgEATwh6o';
%% get randomization
correct_stimlist = readtable(fullfile(seq_dir,'param_ptb','stimlist_PKHDgEATwh6o.txt'));

%% recode maintask
clear data meta
data_file = cellstr(spm_select('FPList',datadir,'PKHDgEATwh6omaintask_.*.mat'));
metadata_file = cellstr(spm_select('FPList',datadir,'PKHDgEATwh6ometa_maintask_.*.mat'));
keepvar = 'stim_img';
...
%% recode localizer
clear data meta
data_file = cellstr(spm_select('FPList',datadir,'PKHDgEATwh6olocalizer_.*.mat'));
metadata_file = cellstr(spm_select('FPList',datadir,'PKHDgEATwh6ometa_localizer_.*.mat'));
