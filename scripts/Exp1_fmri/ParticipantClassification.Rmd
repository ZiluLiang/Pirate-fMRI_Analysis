...
print("N participant:")
print(nsub)
ntrialpersub = nrow(data)/nsub
print("N trial per participant (should be equal to 204+27+25*4 = 331):")
print(ntrialpersub)


# data tidying: rename variables, rescale response to be between -1 and 1
...
print(nrow(meanscanperf) == nsub*25)
...
### get probability for each response
```{r}
...
## Exlude Unreliable participants
