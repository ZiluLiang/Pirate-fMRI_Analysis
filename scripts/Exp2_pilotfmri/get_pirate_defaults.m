...
function pirate_defaults = setdefaults
    ...
    pirate_defaults.packages.scripts      = fullfile(wk_dir,'scripts','Exp2_pilotfmri');
    ...
    pirate_defaults.directory.studydir     = fullfile(wk_dir,'data','Exp2_pilotfmri');
    ...
    pirate_defaults.participants.validids  = pirate_defaults.participants.ids; % exclude sub 31 due to incomplete scans and exclude sub027 due to wierd performance
    ...
    pirate_defaults.participants.nonlearnerids     = {}'; 
    pirate_defaults.participants.nongeneralizerids = {}';
    ...
    %% --------------  naming patterns ------------------
    pirate_defaults.filepattern.task1   = 'sub-.*_task-localizer2AFC_run-[1]';
    pirate_defaults.filepattern.task2   = 'sub-.*_task-pirate2AFC_run-[1-6]';
    pirate_defaults.filepattern.task3   = 'sub-.*_task-symboloddball_run-[1-2]';
    ...
    pirate_defaults.filepattern.raw.functional.task1   = '^sub-.*_task-localizer2AFC_run-[1]';% the first run in this will be used as the first session
    pirate_defaults.filepattern.raw.functional.task2   = '^sub-.*_task-pirate2AFC_run-[1-6]';
    pirate_defaults.filepattern.raw.functional.task3   = '^sub-.*_task-symboloddball_run-[1-2]';
