...
```{r}
model_acc  = glmer(resp_correct~iscompositional*istraining+blocknumber_withinsess + (istraining |subid),
              data=fc_df,family = binomial) 
model_rt   = lmer(resp_rt~iscompositional*istraining+blocknumber_withinsess + (istraining |subid),
              data=fc_df)
